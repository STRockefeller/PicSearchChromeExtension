...
;
function onClickArtStation(info, tab) { link("https://www.artstation.com/search?q=" + info.selectionText + "&sort_by=relevance"); }
;
function onClickDeviantArt(info, tab) { link("https://www.deviantart.com/search?q=" + info.selectionText); }
;
